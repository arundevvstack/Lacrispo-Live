...
const products = [
  {
    id: 1,
    name: "Banana Chips",
    desc: "Crisp and golden sun-ripened Nendran bananas thinly sliced and kettle-cooked in pure coconut oil with a pinch of rock salt.",
  ...
  },
  {
    id: 2,
    name: "Kerala Mixture",
    desc: "The iconic traditional Kerala tea-time mixture featuring crunchy sev, spiced boondi, roasted peanuts, and fried curry leaves.",
  ...
  },
  {
    ...
    desc: "Hand-harvested tender Varikka jackfruit slices fried to an irresistible golden crisp, lightly seasoned with pure rock salt.",
  ...
  },
  {
    id: 4,
    name: "Tapioca Sticks",
    desc: "Fresh Kerala cassava (tapioca) root thinly sliced into crunchy crisps, lightly salted and seasoned with chili flakes.",
