...
export default function CollectionPage() {
  ...
  return (
    <>
      ...
      <main className="bg-[var(--background)] min-h-screen text-[var(--text-primary)] selection:bg-[#EAD0A1] selection:text-black pt-28 sm:pt-36 pb-12 relative overflow-hidden">
